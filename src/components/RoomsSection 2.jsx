...
const texts = {
  ES: {
    ...
    title: "Tu refugio urbano con detalles boutique",
    description: "Mini suites luminosas, amenidades esenciales y servicio humano que se adapta a tu plan.",
    amenities: "1 Cama",
    smartTv: "Smart Tv",
    sliderLabel: "Explora todo",
    badge: "Desde 40 USD"
  },
  EN: {
    eyebrow: "Our rooms",
    title: "Urban refuge with boutique touches",
    description: "Bright mini suites, thoughtful amenities and a caring team ready for any itinerary.",
    amenities: "1 Bed",
    smartTv: "Smart TV",
    sliderLabel: "See more",
    badge: "From 40 USD"
  },
};
    ...
    <section className="rooms-section">
      <div className="rooms-header">
        <div className="rooms-header-text">
          <span className="rooms-eyebrow">{t.eyebrow}</span>
          <h2
            ref={titleRef}
          ...
          <p className="rooms-description">{t.description}</p>
        </div>
        ...
        >
          <span className="rooms-slider-label">{t.sliderLabel}</span>
      ...
      <div ref={setCardsContainerRef} className="room-cards-container">
        {roomsData.map((room, index) => (
          ...
          >
            <div className="room-card-floating">
              <div className="room-badge">{t.badge}</div>
              <RoomCard
