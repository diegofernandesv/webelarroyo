...
export const services = [
  ...
  },
  {
    ...
    t: {
      ES: {
        title: "Seguridad",
        short: "Vigilancia permanente para que descanses tranquilo.",
        tagline: "Tu tranquilidad, nuestra prioridad.",
        long: "Contamos con vigilancia privada las 24 horas del día y circuito cerrado de cámaras en todas las áreas comunes del hotel. Nuestro equipo de seguridad trabaja en coordinación con la recepción para garantizar que tú y tus pertenencias estén siempre protegidos.",
        highlights: [
          "Vigilancia privada 24/7",
          "Circuito cerrado de cámaras",
          "Acceso controlado al edificio",
          "Coordinación con recepción",
          "Zona de alta seguridad en el centro",
        ],
        hours: "Todos los días · 24 horas",
        cta: "Más información",
        ctaHref: "/contacto",
      ...
      EN: {
        title: "Security",
        short: "Round-the-clock surveillance so you can rest easy.",
        tagline: "Your peace of mind, our priority.",
        long: "We have private security 24 hours a day and a closed-circuit camera system covering all common areas of the hotel. Our security team works in coordination with reception to ensure you and your belongings are always protected.",
        highlights: [
          "Private security 24/7",
          "Closed-circuit camera system",
          "Controlled building access",
          "Coordination with reception",
          "High-security area in the city center",
        ],
        hours: "Every day · 24 hours",
